...
const apikey = "4477f958b5a6c3c16696d9d742473e0b"
...
class App extends Component {
  ...
  async componentDidMount() {
    ...
    //Get the API Weather //
    var {data:forecast} = await axios.get("http://api.openweathermap.org/data/2.5/weather?q=Sydney,AU&appid="+apikey);
  ...
  handleChange= () => {
     axios({
        method: "GET",
        url: `http://api.openweathermap.org/data/2.5/weather?q=${this.state.searchInput},AU&appid=${apikey}`,
        headers: {
